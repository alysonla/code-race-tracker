...
export const githubLanguageData = [
  {
    name: 'Python',
    color: '#3EAFA8',
    values: [4, 3, 3, 3, 3, 2, 2, 2, 2, 1, 1]
  },
  {
    name: 'JavaScript',
    color: '#DD78E8',
    values: [1, 1, 1, 1, 1, 1, 1, 1, 1, 2, 2]
  },
  {
    name: 'TypeScript',
    color: '#E882B5',
    values: [8, 7, 6, 6, 7, 5, 3, 3, 3, 3, 3]
  },
  {
    name: 'Java',
    color: '#6F8FF7',
    values: [2, 2, 2, 2, 2, 3, 4, 4, 4, 4, 4]
  },
  {
    name: 'C#',
    color: '#B896EF',
    values: [5, 5, 6, 7, 6, 7, 5, 5, 5, 5, 5]
  },
  {
    name: 'C++',
    color: '#F68570',
  ...
  },
  {
    name: 'PHP',
    color: '#5DAAF8',
    values: [3, 4, 4, 4, 4, 4, 6, 6, 8, 9, 7]
  },
  {
    name: 'Shell',
    color: '#7CA2F7',
    values: [9, 8, 8, 9, 8, 8, 8, 8, 7, 8, 8]
  },
  {
    name: 'C',
    color: '#E88DCA',
    values: [7, 9, 9, 8, 9, 9, 9, 9, 9, 8, 9]
  },
  {
    name: 'Go',
    color: '#F58560',
  ...
  },
  {
    name: 'Ruby',
    color: '#D4A675',
    values: [8, 8, 7, 9, 10, 10, 10, 10, 10, 10, 10]
  },
  {
    name: 'Obj-C',
    color: '#90D698',
